...
import static util.bloom.Apache.Hash.LongHashFunction.NATIVE_LITTLE_ENDIAN;
 ...
 */
class XxHash {
    public static final XxHash INSTANCE = new XxHash();
    public static final XxHash NATIVE_XX = NATIVE_LITTLE_ENDIAN ?
        XxHash.INSTANCE : BigEndian.INSTANCE;

    // Primes if treated as unsigned
    public static final long P1 = -7046029288634856825L;
    public static final long P2 = -4417276706812531889L;
    public static final long P3 = 1609587929392839161L;
    public static final long P4 = -8796714831421723037L;
    public static final long P5 = 2870177450012600261L;
    ...
    public static class BigEndian extends XxHash {
        public static final BigEndian INSTANCE = new BigEndian();
