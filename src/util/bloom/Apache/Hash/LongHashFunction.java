...
import static util.bloom.Apache.Hash.CharSequenceAccess.nativeCharSequenceAccess;
import static util.bloom.Apache.Hash.UnsafeAccess.*;
...
public abstract class LongHashFunction  implements Serializable {
    ...
    public static LongHashFunction xx(long seed) {
    	LongHashFunction aa = XxHash.asLongHashFunctionWithSeed(seed);
